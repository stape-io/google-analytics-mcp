...
Open Claude Desktop and navigate to _Settings -> Developer -> Edit Config_. This opens the configuration file that controls which MCP servers Claude can access.
...
If you're having persistent issues, try running to clear any locallystored state and tokens:
